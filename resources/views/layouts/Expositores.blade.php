                                    ...
                                    <div class="col-lg-8 mx-auto">
                                        ...
                                        <div class="testimonial-block text-center">
                                            <blockquote class="mb-5">
                                                <p>&ldquo;
                                                <h3>Inteligencia Artificial (IA) y Aprendizaje Automático (ML)</h3>
                                                Aplicaciones y casos de uso de IA en la vida cotidiana.Ética y sesgo en
                                                la IA.El impacto de la IA en el futuro del trabajo.&rdquo;</p>
                                            </blockquote>

                                            <div class="author-info">
                                                <div class="author-pic">
                                                    <img src="images/person-1.jpg" alt="Maria Jones"
                                                        class="img-fluid">
                                                </div>
                                    ...
                                    <div class="col-lg-8 mx-auto">
                                        ...
                                        <div class="testimonial-block text-center">
                                            <blockquote class="mb-5">
                                                ...
                                                Conceptos de nube híbrida y computación de borde.Comparación entre nube
                                                pública y privada.Consideraciones de seguridad en la nube.Estrategias de
                                                migración y adopción a la nube.Perspectivas futuras de la computación en
                                                la nube.&rdquo;</p>
                                            </blockquote>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-8 mx-auto">
                                        ...
                                        <div class="testimonial-block text-center">
                                            <blockquote class="mb-5">
                                                <p>&ldquo;
                                                <h3>Blockchain y tecnologías de registro distribuido (DLT)</h3>
                                            ...
                                            <div class="author-info">
                                                <div class="author-pic">
                                                    <img src="images/dennis.jpeg" alt="Maria Jones"
                                                        class="img-fluid">
                                                </div>
                                                <h3 class="font-weight-bold">Dennis Ritchie</h3>
                                                <span class="position d-block mb-3">creador del lenguaje de
