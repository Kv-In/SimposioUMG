...
<head>
    ...
    <title>{{ __('') }} Table Organizadore</title>
    <!-- Incluir los estilos CSS de Bootstrap -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
    <h1 class="text-center text-secondary font-weight-bold p-5"> Añadir Organizadores o Colavoradores</h1>
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <span class="card-title">{{ __('Organizadores') }}</span>
